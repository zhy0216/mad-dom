...
for (const [label, script] of [["source-analysis", "analyze-resume-1.mjs"], ["profile-summary", "profile-summary-resume-1.mjs"]]) {
...
save("finish-sampling-resume-1.json", { at: new Date().toISOString(), completed: true, repeatedRowsToReview: review.length,
