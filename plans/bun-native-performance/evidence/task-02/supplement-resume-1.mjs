...
for (const key of ["resume-1-baseline-source-on", "resume-1-latest-source-on", "resume-1-baseline-source-off", "resume-1-latest-source-off"]) {
...
if (triggers.length) {
  const p = spawnSync(process.execPath, ["plans/bun-native-performance/evidence/task-02/campaign-resume-1.mjs", "supplemental", lane, ffi],
