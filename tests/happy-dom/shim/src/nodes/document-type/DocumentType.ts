...
// Upstream:  happy-dom v20.11.11 @ 64e2c774cadbb8eda5416c1e2bcca5006d1b5df9 (MIT), src/nodes/document-type/DocumentType.js
...
// GAP: the mad-dom facade provides no binding named `DocumentType` yet.
