...
// Upstream:  happy-dom v20.11.11 @ 64e2c774cadbb8eda5416c1e2bcca5006d1b5df9 (MIT), src/console/VirtualConsolePrinter.js
...
// Re-exports the facade public export `VirtualConsolePrinter`;
// the shim default is reference-equal to `(await import('mad-dom')).<Name>`.
// ─────────────────────────────────────────────────────────────────────────────
export { VirtualConsolePrinter as default } from "mad-dom";
