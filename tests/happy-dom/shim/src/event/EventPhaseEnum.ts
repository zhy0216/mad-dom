...
// Upstream:  happy-dom v20.11.11 @ 64e2c774cadbb8eda5416c1e2bcca5006d1b5df9 (MIT), src/event/EventPhaseEnum.js
...
// Re-exports the facade public export `EventPhaseEnum`;
// the shim default is reference-equal to `(await import('mad-dom')).<Name>`.
// ─────────────────────────────────────────────────────────────────────────────
export { EventPhaseEnum as default } from "mad-dom";
