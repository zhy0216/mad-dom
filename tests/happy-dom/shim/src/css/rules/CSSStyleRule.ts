...
// Upstream:  happy-dom v20.11.11 @ 64e2c774cadbb8eda5416c1e2bcca5006d1b5df9 (MIT), src/css/rules/CSSStyleRule.js
...
// Re-exports the facade public export `CSSStyleRule`;
// the shim default is reference-equal to `(await import('mad-dom')).<Name>`.
// ─────────────────────────────────────────────────────────────────────────────
export { CSSStyleRule as default } from "mad-dom";
