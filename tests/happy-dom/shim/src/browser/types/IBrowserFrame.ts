...
// Upstream:  happy-dom v20.11.11 @ 64e2c774cadbb8eda5416c1e2bcca5006d1b5df9 (MIT), src/browser/types/IBrowserFrame.js
// Kind:      type-only — type-only interface; no runtime value upstream
