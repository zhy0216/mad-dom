...
// Upstream path:      packages/happy-dom/test/event/events/ClipboardEvent.test.ts
...
// ─────────────────────────────────────────────────────────────────────────────
import ClipboardEvent from '../../../shim/src/event/events/ClipboardEvent.js';
import DataTransfer from '../../../shim/src/event/DataTransfer.js';
