...
// Upstream path:      packages/happy-dom/test/window/BrowserWindow.test.ts
...
import type Window from '../../shim/src/window/Window.js';
...
import Request from '../../shim/src/fetch/Request.js';
import Response from '../../shim/src/fetch/Response.js';
import Fetch from '../../src/fetch/Fetch.js';
import type MessageEvent from '../../src/event/events/MessageEvent.js';
import Event from '../../shim/src/event/Event.js';
import type ErrorEvent from '../../shim/src/event/events/ErrorEvent.js';
...
import type HTMLDialogElement from '../../shim/src/nodes/html-dialog-element/HTMLDialogElement.js';
...
import type IBrowser from '../../shim/src/browser/types/IBrowser.js';
import type IBrowserFrame from '../../shim/src/browser/types/IBrowserFrame.js';
import type IBrowserPage from '../../shim/src/browser/types/IBrowserPage.js';
import AdoptedStyleSheetCustomElement from '../AdoptedStyleSheetCustomElement.js';
import Location from '../../shim/src/location/Location.js';
import HTMLElementConfig from '../../src/config/HTMLElementConfig.js';

import '../types.d.js';
import type EventTarget from '../../shim/src/event/EventTarget.js';
import EventPhaseEnum from '../../shim/src/event/EventPhaseEnum.js';
...
describe('BrowserWindow', () => {
	...
	describe('constructor()', () => {
		it('Outputs a warning if "enableJavaScriptEvaluation" is enabled in an environment with code generation enabled.', () => {
			...
			spyOn(globalThis.console, 'warn').mockImplementation((...args: any[]) =>
