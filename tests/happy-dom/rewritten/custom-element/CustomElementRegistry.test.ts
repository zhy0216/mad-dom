...
// Upstream path:      packages/happy-dom/test/custom-element/CustomElementRegistry.test.ts
...
import CustomElementRegistry from '../../shim/src/custom-element/CustomElementRegistry.js';
