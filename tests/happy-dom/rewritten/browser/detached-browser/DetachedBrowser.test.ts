...
// Upstream path:      packages/happy-dom/test/browser/detached-browser/DetachedBrowser.test.ts
...
import DetachedBrowserContext from '../../../shim/src/browser/detached-browser/DetachedBrowserContext.js';
