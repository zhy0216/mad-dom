...
// Upstream path:      packages/happy-dom/test/browser/BrowserFrame.test.ts
...
import BrowserNavigationCrossOriginPolicyEnum from '../../shim/src/browser/enums/BrowserNavigationCrossOriginPolicyEnum.js';
