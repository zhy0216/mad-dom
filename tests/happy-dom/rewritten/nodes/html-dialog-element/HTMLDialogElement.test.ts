...
// Upstream path:      packages/happy-dom/test/nodes/html-dialog-element/HTMLDialogElement.test.ts
...
import KeyboardEvent from '../../../shim/src/event/events/KeyboardEvent.js';
