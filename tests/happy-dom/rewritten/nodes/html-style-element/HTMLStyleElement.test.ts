...
// Upstream path:      packages/happy-dom/test/nodes/html-style-element/HTMLStyleElement.test.ts
...
import HTMLStyleElement from '../../../shim/src/nodes/html-style-element/HTMLStyleElement.js';
