...
// Upstream path:      packages/happy-dom/test/nodes/html-label-element/HTMLLabelElement.test.ts
...
import type HTMLLabelElement from '../../../shim/src/nodes/html-label-element/HTMLLabelElement.js';
