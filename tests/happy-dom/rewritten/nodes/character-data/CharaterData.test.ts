...
describe('CharaterData', () => {
	...
	describe('appendData()', () => {
		it('Appends data.', () => {
			...
			spyOn(CharacterDataUtility, 'appendData').mockImplementation((characterData, data) => {
	...
	describe('deleteData()', () => {
		it('Deletes data.', () => {
			...
			spyOn(CharacterDataUtility, 'deleteData').mockImplementation(
	...
	describe('insertData()', () => {
		it('Inserts data.', () => {
			...
			spyOn(CharacterDataUtility, 'insertData').mockImplementation(
	...
	describe('replaceData()', () => {
		it('Replaces data.', () => {
			...
			spyOn(CharacterDataUtility, 'replaceData').mockImplementation(
	...
	describe('substringData()', () => {
		it('Returns a sub-string.', () => {
			...
			spyOn(CharacterDataUtility, 'substringData').mockImplementation(
				(characterData, offset, count) => {
					expect(characterData).toBe(node);
					expect(offset).toBe(expectedOffset);
					expect(count).toBe(expectedCount);
