...
// Upstream path:      packages/happy-dom/test/nodes/html-head-element/HTMLHeadElement.test.ts
...
// ─────────────────────────────────────────────────────────────────────────────
import HTMLHeadElement from '../../../shim/src/nodes/html-head-element/HTMLHeadElement.js';
