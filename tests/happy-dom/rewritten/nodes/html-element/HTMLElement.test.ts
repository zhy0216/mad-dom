...
import type SVGElement from '../../../shim/src/nodes/svg-element/SVGElement.js';
import Window from '../../../shim/src/window/Window.js';
import CustomElement from '../../CustomElement.js';
import * as PropertySymbol from '../../../shim/src/PropertySymbol.js';
import type CustomElementRegistry from '../../../shim/src/custom-element/CustomElementRegistry.js';
...
describe('HTMLElement', () => {
	...
	describe('blur()', () => {
		it('Calls HTMLElementUtility.blur().', () => {
			...
			spyOn(HTMLElementUtility, 'blur').mockImplementation(
	...
	describe('focus()', () => {
		it('Calls HTMLElementUtility.focus().', () => {
			...
			spyOn(HTMLElementUtility, 'focus').mockImplementation(
				(element: HTMLElement | SVGElement) => {
