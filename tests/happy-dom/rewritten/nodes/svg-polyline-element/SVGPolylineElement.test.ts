...
import SVGPolylineElement from '../../../src/nodes/svg-polyline-element/SVGPolylineElement.js';
...
describe('SVGPolylineElement', () => {
	let window: Window;
	let document: Document;
	let element: SVGPolylineElement;
	...
	describe('constructor()', () => {
		it('Should be an instanceof SVGPolylineElement', () => {
			expect(element instanceof SVGPolylineElement).toBe(true);
		});
