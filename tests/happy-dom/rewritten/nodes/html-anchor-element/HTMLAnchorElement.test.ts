...
import type HTMLAnchorElement from '../../../shim/src/nodes/html-anchor-element/HTMLAnchorElement.js';
...
describe('HTMLAnchorElement', () => {
	...
	describe('dispatchEvent()', () => {
		...
		it('Handles "noopener" and "noreferrer" set in the "rel" attribute.', async () => {
			...
			spyOn(window, 'open').mockImplementation((url, target, features): BrowserWindow => {
				usedURL = <string>url;
