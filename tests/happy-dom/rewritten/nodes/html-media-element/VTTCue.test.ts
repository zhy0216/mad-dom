...
// Upstream path:      packages/happy-dom/test/nodes/html-media-element/VTTCue.test.ts
...
import TextTrackCue from '../../../shim/src/nodes/html-media-element/TextTrackCue.js';
