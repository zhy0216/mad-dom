...
// Upstream path:      packages/happy-dom/test/nodes/html-slot-element/HTMLSlotElement.test.ts
...
import type HTMLSlotElement from '../../../shim/src/nodes/html-slot-element/HTMLSlotElement.js';
