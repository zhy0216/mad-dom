...
// Upstream path:      packages/happy-dom/test/nodes/html-area-element/HTMLAreaElement.test.ts
// Source:             hand-ported to public API (plans/0002 §4)
//
// Hand-ported to public API: the public HTMLAreaElement surface — the
// attribute reflections (download/ping/target/referrerPolicy/rel/alt/coords/
// shape), the relList DOMTokenList, the hyperlink URL parts (href/origin/
...
// ─────────────────────────────────────────────────────────────────────────────
export const id = "nodes-html-area-element";
export const description = "real differential: public HTMLAreaElement attribute reflections, relList, hyperlink URL parts and tabIndex";
...
export async function run(api) {
  ...
  try {
    ...
    for (const property of ["download", "ping", "target", "referrerPolicy", "rel", "alt", "coords", "shape"]) {
    ...
    // username / password getters / setters.
    ...
    // pathname / search / hash getters / setters.
    element.setAttribute("href", "https://www.example.com:443/path?q1=a#xyz");
    ...
    // tabIndex.
    const fresh = document.createElement("area");
